...
-> (optionel) Déplacer le fichier msedgedriver.exe dans un endroit facile à retrouver, par exemple :
```
```
...
-> Taper exactement ceci et appuyer sur Entrée (Enter) :
```
```
...
DONE_FOLDER = r"C:\Users\VotreNom\Downloads\VosDossierImages\used"
```
...
EDGE_DRIVER_PATH = r"C:\Users\VotreNom\Downloads\edgedriver_win64\msedgedriver.exe"
